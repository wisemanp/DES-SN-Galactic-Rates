...
The SN Ia rates generated by the posterior predictive checks are shown in Fig. \ref{fig:rate_fitted_split_x1_joint}. The best fitting values are $t_1 = 0.65 \pm 0.1$~Gyr and $t_2 = 0.85 \pm 0.15$~Gyr, corresponding to a relatively sharp transition between the two populations. 
