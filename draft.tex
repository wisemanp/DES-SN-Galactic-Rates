...
\begin{figure}
    ...
    \caption{SN detection efficiencies split up by DES field. The $y-$axis represents the fraction of simulated SNe in a given redshift bin that would have been detected by DES-SN and passed light curve quality cuts. The curves are capped at efficiencies around 0.5 because DES is restricted to $\sim6$ month observing seasons each calendar year.
