...
\begin{enumerate}
    ...
    \item field galaxies must covered by $ugrizJHK$ photometry, with a photometric flux measurement or upper limit present in all bands;
...
\begin{table}
	...
	\begin{tabular}{crr} % four columns, alignment for each
		...
		$x_1 > 0$ & $-1.68\pm0.15$ & $0.51\pm0.12$ \\
		$c < 0$ & $-1.09\pm0.08$ & $0.89\pm0.04$ \\
