...
The SN Ia rate as a function of stellar mass and the best fitting model for SNe split by stretch is shown in Fig. \ref{fig:rate_fitted_split_x1}. The evolution of the rate with stellar mass is significantly different for the two sub-samples: high-stretch SNe dominate the rate at low stellar mass but tail off in the higher mass galaxies, while low-stretch SNe are subdominant in low mass galaxies but display a much stronger correlation with mass and make up nearly all SNe in high-mass hosts.
