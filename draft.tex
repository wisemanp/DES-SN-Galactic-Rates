...
\begin{figure}
    \centering
    \includegraphics[width=.5\textwidth]{figs/beta_A_corner.png}
...
\begin{table}
	...
	\begin{tabular}{lccr} % four columns, alignment for each
		...
		\hline
		Fixed $t_{\mathrm{p}}$ & $-1.03\pm 0.06$ &  $1.7 \pm 0.05$ & -\\
