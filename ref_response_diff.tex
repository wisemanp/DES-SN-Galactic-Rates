...
\providecommand{\DIFadd}[1]{\protect\cbstart{#1}\protect\cbend} %DIF PREAMBLE
\providecommand{\DIFdel}[1]{\protect\cbdelete} %DIF PREAMBLE
...
%DIF DIFCODE_CHANGEBAR %DIF PREAMBLE
